...
//changed all to parameterised SQL queries to protect the file data and table from SQL injection
...
module.exports.getFileData = (userId, pageNumber, search) => {
        ...
        SET @total_records =(SELECT count(file_id) FROM file WHERE created_by_id= ${userId}   );SELECT @total_records total_records; `;
            ...
            console.log(`SELECT file_id,cloudinary_url,design_title,design_description 
